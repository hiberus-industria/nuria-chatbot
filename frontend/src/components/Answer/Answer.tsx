  ...
  const handleGeneratePDF = (ticketData: any) => {
    ...
    const props = {
      ...
      contact: {
        ...
        name: 'Client Name',
        address: 'Main Street 123, 28001 Madrid, Spain',
        phone: 'Phone: +34 911 222 333',
      ...
      invoice: {
        ...
        header: [
          { title: 'SKU', style: { width: 35 } },
          { title: 'Description', style: { width: 80 } },
          { title: 'Color', style: { width: 30 } },
          { title: 'Quant.', style: { width: 20 } },
          { title: 'Price', style: { width: 25 } }
        ],
        table: ticketData.items.map((item, _index) => [
          item.sku || 'N/A',
          item.description ? `${item.category} - ${item.description}` : 'N/A',
          item.color || 'N/A',
          '1',
      ...
      footer: {
        text: 'This document is valid without signature or stamp.'
      },
      pageEnable: true,
      pageLabel: 'Page '
    }
